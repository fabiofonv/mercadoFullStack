angular.module("elephant")
  ...
  .controller("DashboardCtrl", function($scope) {
    $scope.visitors = {
      ...
      colors: [{
        backgroundColor: "rgba(0, 172, 237, 0.03)",
        borderColor: "#00aced",
